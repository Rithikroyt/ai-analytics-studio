...
import SQLPythonLab from '@/pages/v2/SQLPythonLab.jsx';
import AIAnalystTeam from '@/pages/v2/AIAnalystTeam.jsx';
import SupplyChainOps from '@/pages/v2/SupplyChainOps';
import MarketingStudioV2 from '@/pages/v2/MarketingStudio.jsx';
import AdvancedAnalyticsLabV2 from '@/pages/v2/AdvancedAnalyticsLabV2.jsx';
