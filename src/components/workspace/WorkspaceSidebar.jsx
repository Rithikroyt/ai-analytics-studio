          ...
          return (
            <button
              ...
              style={isActive ? {
                ...
                boxShadow: collapsed ? '0 0 12px rgba(0,229,255,0.15)' : 'none',
              } : {}}
            >
              {/* Circle button in collapsed mode */}
              {collapsed ? (
                <div className={`w-9 h-9 rounded-full flex items-center justify-center transition-all ${
                  isActive ? 'bg-cyan-400/15 shadow-[0_0_12px_rgba(0,229,255,0.3)]' : 'hover:bg-white/8'
                }`}>
