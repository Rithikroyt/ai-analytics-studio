      ...
      <div className="p-5">
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-5">
            ...
            {/* Prompt to upgrade with AI analysis if no chart panels */}
            {!r.chartPanels?.length && (
              <div className="flex items-center gap-4 p-4 rounded-2xl border border-purple-400/20 bg-purple-400/5">
                <Sparkles className="w-5 h-5 text-purple-400 flex-shrink-0" />
                <div className="flex-1">
                  <div className="text-sm font-semibold text-purple-400">AI Chart Panels Available</div>
                  <div className="text-xs text-white/45 mt-0.5">Go to Prepare &amp; run AI Analysis to generate 6–8 custom AI-designed charts for this dataset.</div>
                </div>
